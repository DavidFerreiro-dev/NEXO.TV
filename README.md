...
## 📖 Sobre este Proyecto
Este repositorio es el resultado de un proyecto académico para **CS50**. El objetivo principal es demostrar habilidades en desarrollo web, gestión de bases de datos JSON y curaduría de contenidos digitales.
...
* **NEXO Originals:** Demostración de contenido editado (como nuestra edición de *Superman 1941* con doblaje propio).
...
1.  **NEXO.TV: Häxan (1922)** - Selección de culto.
2.  **Sin Novedad en el Frente (1930)** - Cine sonoro temprano.
3.  **Superman Collection (1941)** - Ejercicio de doblaje y edición.
4.  **Metrópolis (1927)** y **Nosferatu (1922)** - Expresionismo Alemán.
